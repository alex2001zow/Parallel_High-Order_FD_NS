...
subroutine run_simulation()
   use constants_module, only: MASTER_RANK, filename_txt, filename_dat, filename_layout_dat
   ...
   call write_rank_type_blocks_to_file(rank_params, filename_dat, filename_layout_dat)
